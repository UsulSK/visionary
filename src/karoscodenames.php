...
<html lang="en">
  ...
  <body>
	...
	if (!isset($_GET["code"]) && !isset($_GET["names"])) {
		...
		echo $_SERVER['SERVER_NAME'] . '/karoscodenames.php?names=' . $names . '<br><br><br>';
		
		echo 'Please copy the following link, open it and share it with the other team captain:<br><br>';
